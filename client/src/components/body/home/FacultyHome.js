  ...
  useEffect(() => {
      if(user && iam === 'faculty'){
            const fetchData = async () => {
                try{
                    const gatePassRes = await axios.post(`/${iam}/get/gatepass`,{ facultyEmail: user.email, year: user.year, facultyDepartment:user.department});
                    //const sickPassRes = await axios.post(`/${iam}/get/sickpass`,{ facultyEmail: user.email, year: user.year, facultyDepartment:user.department});
                    const eventPassRes = await axios.post(`/${iam}/get/eventpass`,{ facultyEmail: user.email, year: user.year, facultyDepartment:user.department});
                    const otherPassRes = await axios.post(`/${iam}/get/otherpass`,{ facultyEmail: user.email, year: user.year, facultyDepartment:user.department});
